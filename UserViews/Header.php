            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/img/user.png" alt="user" class="profile-pic" /></a>
                                    ...
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted"><?php echo $u->email; ?></p></div>
                                        </div>
                                    </li>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="assets/img/user.png" alt="user" />
                    ...
                    <div class="profile-text">
                        ...
                        <a href="Controller/UserController.php?fn=Logout" style="color:#fff" class="btn-danger" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="user.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a>
