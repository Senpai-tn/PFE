...
<head>
    ...
    <link href="assets/AdminAssets/css/colors/blue.css" id="theme" rel="stylesheet">
...
<body class="fix-header fix-sidebar card-no-border">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="assets/img/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="assets/img/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="assets/img/big/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="assets/img/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover earning-box">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width:50px;"><span class="round"><img src="assets/img/users/8.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr class="active">
                                                <td><span class="round"><img src="assets/img/users/2.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-success"><img src="assets/img/users/1.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-primary"><img src="assets/img/users/4.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-warning"><img src="assets/img/users/5.jpg" alt="user" width="50"></span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><span class="round round-danger"><img src="assets/img/users/1.jpg" alt="user" width="50"></span></td>
                                                <td>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets m-b-20">
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="assets/img/users/1.jpg" alt="user" width="50"></span></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row ">
                                    <div class="p-2"><span class="round"><img src="assets/img/users/2.jpg" alt="user" width="50"></span></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="assets/img/users/3.jpg" alt="user" width="50"></span></div>
                                    <div class="comment-text w-100">
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><span class="round"><img src="assets/img/users/4.jpg" alt="user" width="50"></span></div>
                                    <div class="comment-text w-100">
                                        <h5>James Anderson</h5>
                                        <div class="comment-footer">
                                            <span class="date">April 14, 2016</span>
                                ...
                                <div class="to-do-widget m-t-20">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="assets/img/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li><img src="assets/img/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li><img src="assets/img/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li><img src="assets/img/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item" data-role="task">
                                            <div class="checkbox checkbox-info">
                                        ...
                                        <li class="list-group-item" data-role="task">
                                            ...
                                            <ul class="assignedto">
                                                <li><img src="assets/img/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Steave"></li>
                                                <li><img src="assets/img/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Jessica"></li>
                                                <li><img src="assets/img/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Assign to Selina"></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-4 col-xlg-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body little-profile text-center">
                                <div class="pro-img"><img src="assets/img/users/4.jpg" alt="user" /></div>
                        ...
                        <!-- Column -->
                        <div class="card">
                            <div class="card-body bg-inverse" style="background: url(assets/img/background/user-info.jpg) / cover;">
                    ...
                    <div class="slimscrollright">
                        ...
                        <div class="r-panel-body">
                            ...
                            <ul class="m-t-20 chatonline">
                                ...
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/1.jpg" alt="user-img" class="img-circle"> <span>Varun Dhavan <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/2.jpg" alt="user-img" class="img-circle"> <span>Genelia Deshmukh <small class="text-warning">Away</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/3.jpg" alt="user-img" class="img-circle"> <span>Ritesh Deshmukh <small class="text-danger">Busy</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/4.jpg" alt="user-img" class="img-circle"> <span>Arijit Sinh <small class="text-muted">Offline</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/5.jpg" alt="user-img" class="img-circle"> <span>Govinda Star <small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/6.jpg" alt="user-img" class="img-circle"> <span>John Abraham<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/7.jpg" alt="user-img" class="img-circle"> <span>Hritik Roshan<small class="text-success">online</small></span></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)"><img src="assets/img/users/8.jpg" alt="user-img" class="img-circle"> <span>Pwandeep rajan <small class="text-success">online</small></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <script src="assets/AdminAssets/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="assets/AdminAssets/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="assets/AdminAssets/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="assets/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <!--Custom JavaScript -->
    <script src="assets/AdminAssets/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
