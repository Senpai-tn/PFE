...
$sql = 'SELECT count(*) FROM users where idStation= ' . $u->idStation;
$result = $con->query($sql);
$users = $result->fetch_array();

$sql = 'SELECT count(*) FROM sensors where idStation= ' . $u->idStation;
$result = $con->query($sql);
$sensors = $result->fetch_array();

$sql =
    'SELECT count(*) FROM `data` d, sensors s WHERE d.ref = s.ref and s.idStation = ' .
    $u->idStation;
$result = $con->query($sql);
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h6 class="card-subtitle">Users in your station</h6></div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h6 class="card-subtitle">Sensors in your station</h6></div>
                                <div class="col-12">
                                    <div class="progress">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h6 class="card-subtitle">Data in your station</h6></div>
                                <div class="col-12">
                                    <div class="progress">
